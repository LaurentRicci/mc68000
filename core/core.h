...
{
	/// <summary>
	/// The core class register the handlers for the various instruction
	/// </summary>
	/// <typeparam name="T">A concrete class implementing the instructions handlers</typeparam>
	...
	public:
		...
		static t_handler handlers[0x10000];
