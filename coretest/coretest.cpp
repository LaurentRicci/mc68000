...
{
    validateDecode(0b0100'100'111'000'110u, instructions::ILLEGAL, L"ILLEGAL"); // EXTB.L D6 only MC68020+
}
...
{
    // 68010 and up only
    validateDecode(0b0100'0010'11'010'010u, instructions::ILLEGAL, L"ILLEGAL");
}
